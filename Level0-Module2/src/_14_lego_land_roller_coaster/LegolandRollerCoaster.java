...
public class LegolandRollerCoaster {
	...
	/* 1) Make a main method that includes all the steps below…. */
		...
		/* 4) if heightAsInt is greater than 42 inches, print "You can ride the LEGO TECHNIC coaster!" using JOptionPane */
		
		
		/* 5) if the heightAsInt is greater than 48 inches, print "Hurray! You are tall enough to ride the LEGO coaster alone!" */
