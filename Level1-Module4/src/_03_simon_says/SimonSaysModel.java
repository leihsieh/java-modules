...
public class SimonSaysModel {
	...
	SimonSaysModel() {
		...
		/*
		 * 3. Drag and drop four images that show keyboard arrow keys into the recipe package. 
		 *    Or you can use the images we already put there
		 */

		// 4. Make a URL variable for each of the arrow images. The first one has been done for
	...
	public boolean tooManyTries() {
		...
		// Hint: There is a MAX_TRIES value above
		return false;
	}
