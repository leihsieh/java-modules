...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		int userInput = Integer.parseInt(JOptionPane.showInputDialog("Enter a positive number"));
		...
		JOptionPane.showMessageDialog(null, "Find the button marked 'ME'");
		//13. initialize the hiddenButton variable to a random number less than the int created int step 3
		hiddenButton = rand.nextInt(userInput);
