...
public class DuelingButtons {
	...
	DuelingButtons() {
		//This constructor creates a controller before building the view for his program
	...
	private void makeFrame() {
		...
		/* The View in this program consists of 4 Components: a frame, a panel, and two buttons */
	...
	public void makeSmall(JButton button) {
		...
		// 8.3 Make the OTHER button big (use the makeBig method below)
